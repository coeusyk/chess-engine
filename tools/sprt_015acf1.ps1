<#
.SYNOPSIS
    SPRT: 015acf1 (SEE hanging penalty) vs Vex-0.4.9
...
$PgnOut = Join-Path $ResultsDir "sprt_015acf1_$TS.pgn"

Write-Host "SPRT: 015acf1 vs 0.4.9  H0=0 H1=50 alpha=0.05 beta=0.05  TC=10+0.1"
