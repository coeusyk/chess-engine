...
public final class PawnStructure {
    ...
    private static final int[] PASSED_MG = {0, 0, 0, 0, 0, 0, 0, 0};
    private static final int[] PASSED_EG = {0, 0, 0, 0, 0, 57, 30, 0};

    private static final int ISOLATED_MG = 2;
    private static final int ISOLATED_EG = 13;

    private static final int DOUBLED_MG = 17;
    private static final int DOUBLED_EG = 11;
