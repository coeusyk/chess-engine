...
public class Searcher {
    ...
    // SIZE=4096 (12-bit key); the pawn hash key derivation below uses >>> 52 to match.
    ...
    private int alphaBeta(
        ...
        if (!aborted && bestScore != -INF) {
            ...
            if (!inSingularitySearch && !sideToMoveInCheck) {
                ...
                // C-6b: weight deeper observations more (shallower nodes see less-stable positions).
